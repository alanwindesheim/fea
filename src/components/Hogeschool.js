...
import co2 from "../images/euro.png";
import charger from "../images/beer.png";
import { Helmet } from "react-helmet";

class Hogeschool extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    var liftEnergie = ((this.state.users * 1.83) / 100).toFixed(2);
      ...
      >
        <Container>
          ...
          <Row className="AantalGebruikLiftRow">
            <Col className="AantalGebruiktLifCol1Hogeschool">
              <h1 className="FireBaseDataH1" style={{ color: "#ffcd19" }}>
                {this.state.users}{" "}
              </h1>
            ...
            <Col className="AantalGebruiktLifCol2Hogeschool">
              <h1 className="FireBaseDataH1" style={{ color: "#ffcd19" }}>
                {value}
              </h1>
              <img src={co2} id="AantalGebruikLiftImage1" alt="" />
              <h2 className="AantalGebruiktH2">
                zoveel euro elektriciteit is er vandaag uitgegeven door de lift
              </h2>
            </Col>
            <Col className="AantalGebruiktLifCol3Hogeschool">
              <h1 className="FireBaseDataH1" style={{ color: "#ffcd19" }}>
                {Math.round(value / 0.7).toFixed(0)}
              </h1>
              <img src={charger} id="AantalGebruikLiftImage1" alt="" />
              <h2 className="AantalGebruiktH2">
                zoveel bier kon er gehaald worden
              </h2>
            </Col>
          </Row>
        </Container>
        ...
        <Container>
          ...
          <Row className="GrafiekGebruikLiftRow">
            ...
            <Col className="GrafiekGebruikLiftCol2Hogeschool">
              <Doughnut
                height={500}
                width={450}
                data={data}
